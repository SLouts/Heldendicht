...
/**
 * 角色必填欄位(world_character_fields)的編輯清單——跟補充章節
 * (SectionTemplatesSection)結構很像,但這裡多一個「共用/只有 PC/只有
 * NPC」的選擇器,是這張表獨有的需求,所以不硬塞進共用元件,獨立成自己
 * 的檔案(沿用原本 CharacterFieldsEditor.tsx 的理由)。
 */
  ...
  return (
    <div className="mt-4">
      ...
      >
        ...
        <div className="flex flex-col gap-1">
          <label htmlFor="new-field-example" className="text-sm font-medium">
            範例值(選填)
          </label>
          <input
